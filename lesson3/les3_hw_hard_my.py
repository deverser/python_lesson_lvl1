...
def fighting(player1, player2):
    '''Битва персонажей'''
    name1 = player1['name'].title()
    name2 = player2['name'].title()
    ...
    while health > 0:
        ...
        if health <=0:
            health = 0
            print(
                '{} attacks {} with {}. {}\'s xp is {}. {} wins the fight!'.format(
                    name1, name2, damage, name2, health, name1))
            break
        print('{} attacks {} with {} dmg. {}\'s xp is {}'.format(
            name1, name2, damage, name2, health))

##def epic_fight(attack1,attack2):
